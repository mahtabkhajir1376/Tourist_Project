...
const ImageLayout: React.FC<ImageLayout> = ({ ImageSrc,span,header,capacity,position }) => {
  return (
    <Link href={"/detailspage"} className={`border-[1px] border-[#01A657]  rounded-3xl flex flex-row justify-center items-center 2xl:px-6 2xl:py-5 sm:px-2 sm:py-2 md:px-2 md:py-2 lg:px-4 lg:py-4 relative  ${span}`}>

...
const SingleOption: React.FC<Option> = ({
  ...
  return (
    <div className={`${bgImage} bg-cover w-[30%] h-[396px] flex justify-center items-center bg-center `}>
      <div className="flex flex-col justify-center items-start w-[68%]  pr-12 pb-2" >

...
const Navbar:React.FC<Props>=({bgColor})=> {
  ...
  return (
    <nav className={`flex flex-row items-center justify-between xl:px-8 xl:text-lg xl:py-2 ${bgColor} font-semibold sm-w-full sm:px-2  sm:py-1 sm:text-sm md-text-base lg:text-lg  xl:w-full md:w-full md:px-2 md:py-1 lg:px:6 lg:py-1 lg:w-full`} >

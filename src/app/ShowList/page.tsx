  ...
  return (
    <>
      <div className="font-iransans bg-[#F8F8F8] ">
        ...
        <div className="flex flex-row font-iransans w-[1440px]  top-[128px] left-[1px] justify-center items-center ">
          ...
          <div className="w-[821px] h-[950px] top-[102px] left-[46px] gap-[32px] mr-[40px]   ">
            <ShowListCart />
          </div>
        </div>
